...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-752591.772869, -1042254.701049, -751720.272869, -1041674.186835], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:5514',
            extent: [-910000.000000, -1230000.000000, -427819.042600, -930000.000000],
            units: 'm'})
    })
});
...
map.getView().fit([-752591.772869, -1042254.701049, -751720.272869, -1041674.186835], map.getSize());
